...
class AppTextStyles {
  ...
  static const appBarBlackText = TextStyle(color: Colors.black, fontWeight: FontWeight.w900, fontFamily: 'OpenSans');
  ...
  static const greyBoldText17 = TextStyle(color: AppColors.greyText, fontWeight: FontWeight.bold, fontFamily: 'OpenSans', fontSize: 17);
